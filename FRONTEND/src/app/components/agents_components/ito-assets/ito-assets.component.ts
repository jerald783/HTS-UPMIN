...
@Component({
  selector: 'app-ito-assets',
  standalone: false,
  templateUrl: './ito-assets.component.html',
  styleUrl: './ito-assets.component.scss',
})
export class ItoAssetsComponent implements OnInit, AfterViewInit {
