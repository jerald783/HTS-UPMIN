...
export class EmailService {
  ...
  sendVerification(data: any) {
    return this.http.post(
      `${this.apiUrlSendVerification}/send-verification`,
      data,
    );
  }
  ...
  verifyAndRegister(data: any) {
    return this.http.post(
      `${this.apiUrlSendVerification}/verify-register`,
      data,
    );
  }

  forgotPassword(email: any) {
    return this.http.post(`${this.apiUrlForgotPassword}/forgot-password`, {
      email,
    });
  }
